...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/knot-rider/security/advisories/new)
...
directly. No PGP key is currently published for this repository — plain email
is the only alternative channel.
...
- This repository (`hyperpolymath/knot-rider`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/knot-rider/security/advisories)
...
When using knot-rider, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/knot-rider/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/knot-rider/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/knot-rider/discussions) |
...
*Thank you for helping keep knot-rider and its users safe.* 🛡️
