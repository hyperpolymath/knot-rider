...
;;
;; Guix package definition for knot-rider
;;
;; Usage:
;;   guix shell -D -f guix.scm    # Enter development shell
;;   guix build -f guix.scm       # Build package
;;
;; TODO: Replace knot-rider and customize inputs for your language/stack.
...
(package
  ...
  (home-page "https://github.com/hyperpolymath/knot-rider")
  (synopsis "Not yet documented — see README.adoc")
