...
# knot-rider container entrypoint
#
...
cleanup() {
    echo "Received shutdown signal — stopping knot-rider..."
...
# Examples:
#   exec /app/knot-rider
#   exec /app/release/bin/knot-rider start
#   exec /app/knot-rider serve --host "${APP_HOST}" --port "${APP_PORT}"
